...
def test_compute_vt_chords():
    ...
    span = problem.get_val("data:geometry:vertical_tail:span", units="ft")
    root_chord = problem.get_val("data:geometry:vertical_tail:root:chord", units="ft")
    tip_chord = problem.get_val("data:geometry:vertical_tail:tip:chord", units="ft")
...
def test_compute_vt_mac():
    ...
    length = problem.get_val("data:geometry:vertical_tail:MAC:length", units="ft")
    vt_x0 = problem.get_val("data:geometry:vertical_tail:MAC:at25percent:x:local", units="ft")
    vt_z0 = problem.get_val("data:geometry:vertical_tail:MAC:z", units="ft")
    vt_lp = problem.get_val(
        "data:geometry:vertical_tail:MAC:at25percent:x:from_wingMAC25", units="ft"
    )
...
def test_compute_ht_mac():
    ...
    length = problem.get_val("data:geometry:horizontal_tail:MAC:length", units="ft")
    ht_x0 = problem.get_val("data:geometry:horizontal_tail:MAC:at25percent:x:local", units="ft")
    ht_y0 = problem.get_val("data:geometry:horizontal_tail:MAC:y", units="ft")
...
def test_compute_ht_mac_fl():
    ...
    lp_ht = problem.get_val(
        "data:geometry:horizontal_tail:MAC:at25percent:x:from_wingMAC25", units="ft"
    )
    assert length == pytest.approx(0.983, abs=1e-3)
    assert ht_x0 == pytest.approx(0.065, abs=1e-3)
    assert ht_y0 == pytest.approx(0.943, abs=1e-3)
...
def test_compute_ht_wet_area():
    ...
    wet_area = problem.get_val("data:geometry:horizontal_tail:wet_area", units="ft**2")
...
def test_fuselage_wet_area():
    ...
    fuselage_wet_area = problem.get_val("data:geometry:fuselage:wet_area", units="ft**2")
...
def test_geometry_wing_l1_l4():
    ...
    wing_l1 = problem.get_val("data:geometry:wing:root:virtual_chord", units="ft")
...
def test_geometry_wing_mac():
    ...
    wing_l0 = problem.get_val("data:geometry:wing:MAC:length", units="ft")
    wing_x0 = problem.get_val("data:geometry:wing:MAC:leading_edge:x:local", units="ft")
    wing_y0 = problem.get_val("data:geometry:wing:MAC:y", units="ft")
...
def test_geometry_wing_wet_area():
    ...
    area_pf = problem.get_val("data:geometry:wing:outer_area", units="ft**2")
    wet_area = problem.get_val("data:geometry:wing:wet_area", units="ft**2")
...
def test_landing_gear_geometry():
    ...
    lg_height = problem.get_val("data:geometry:landing_gear:height", units="ft")
    lg_position = problem.get_val("data:geometry:landing_gear:y", units="ft")
