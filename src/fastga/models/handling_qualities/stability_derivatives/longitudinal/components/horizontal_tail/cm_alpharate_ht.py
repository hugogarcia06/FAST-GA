...
import numpy as np
import math
from fastga.models.handling_qualities.utils.downwash import get_downwash
from fastga.models.handling_qualities.utils.lift_curve_slope import get_lift_curve_slope


class CmAlphaRateHT(om.ExplicitComponent):
    # TODOC
    """
    ...
    def setup(self):
        ...
        self.add_output("data:handling_qualities:longitudinal:derivatives:horizontal_tail:Cm:alpharate", units="rad**-1")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        Cm_alpharate_H = -2 * CL_alpha_H * eta_H * V_H * l_H / mac_W * deps_dalpha
        outputs["data:handling_qualities:longitudinal:derivatives:horizontal_tail:Cm:alpharate"] = Cm_alpharate_H
