...
# TODO: register class
class CnRollRateVT(FigureDigitization2):
    ...
    def setup(self):
        ...
        self.add_output("data:handling_qualities:lateral:derivatives:vertical_tail:Cn:rollrate", units="rad**-1")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        z = float(z_v*math.cos(alpha) - l_v*math.sin(alpha))
        Cn_p_V = - (2/b**2) * CY_beta_V * (l_v*math.cos(alpha) + z_v*math.sin(alpha)) * (z - z_v)

        outputs["data:handling_qualities:lateral:derivatives:vertical_tail:Cn:rollrate"] = Cn_p_V
