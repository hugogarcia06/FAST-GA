...
# TODO:register class
class ClRollRateVT(FigureDigitization2):
    ...
    def setup(self):
        ...
        self.add_output("data:handling_qualities:lateral:derivatives:vertical_tail:Cl:rollrate", units="rad**-1")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        # Vertical tail contribution to Cl_p
        z = z_v * math.cos(alpha) - l_v * math.sin(alpha)
        Cl_p_V = 2 / (b ** 2) * CY_beta_V * abs(z * (z - z_v))


        outputs["data:handling_qualities:lateral:derivatives:vertical_tail:Cl:rollrate"] = Cl_p_V