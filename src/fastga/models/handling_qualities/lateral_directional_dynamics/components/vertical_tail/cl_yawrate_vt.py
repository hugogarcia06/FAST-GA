...
# TODO: register class
class ClYawRateVT(FigureDigitization2):
    ...
    def setup(self):
        ...
        self.add_output("data:handling_qualities:lateral:derivatives:vertical_tail:Cl:yawrate", units="rad**-1")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        Cl_r_V = - (2 / b ** 2) * (l_v * math.cos(alpha) + z_v * math.sin(alpha)) * z * CY_beta_V

        outputs["data:handling_qualities:lateral:derivatives:vertical_tail:Cl:yawrate"] = Cl_r_V
