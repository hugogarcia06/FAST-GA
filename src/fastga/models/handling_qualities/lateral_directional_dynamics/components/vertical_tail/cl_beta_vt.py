...
# TODO: register class
class ClBetaVT(FigureDigitization2):
    ...
    def setup(self):
        ...
        self.add_output("data:handling_qualities:lateral:derivatives:vertical_tail:Cl:beta", units="rad**-1")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        Cl_beta_V = float(CY_beta_V * z / b)

        outputs["data:handling_qualities:lateral:derivatives:vertical_tail:Cl:beta"] = Cl_beta_V
