...
# TODO: register class
class CnYawRateVT(FigureDigitization2):
    ...
    def setup(self):
        ...
        self.add_output("data:handling_qualities:lateral:derivatives:vertical_tail:Cn:yawrate", units="rad**-1")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        Cn_r_V = (2 / b ** 2) * (l_v * math.cos(alpha) + z_v * math.sin(alpha)) ** 2 * CY_beta_V

        outputs["data:handling_qualities:lateral:derivatives:vertical_tail:Cn:yawrate"] = Cn_r_V
