...
class CLPitchRateHT(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output("data:handling_qualities:longitudinal:derivatives:horizontal_tail:CL:pitchrate",
                        units="rad**-1")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        # Horizontal Tail Geometry
        # TODO: modificar, no es exactamente l_h
        ...
        # USAF DATCOM presents the following equation for the computation of the horizontal tail contribution
        # TODO: to implement this method we need to define exposed surfaces.
        # K_WB = FigureDigitization2.get_k_wb(d, b_H)
        # K_BW = FigureDigitization2.get_k_bw(d, b_H)
        # CL_q_H = 2 * (K_WB + K_BW) * CL_alpha_H * eta_H * V_H

        # In Roskam's, the equation presented is simplified:
        CL_q_H = 2 * CL_alpha_H * eta_H * V_H

        outputs["data:handling_qualities:longitudinal:derivatives:horizontal_tail:CL:pitchrate"] = CL_q_H
